...
<body>
    ...
    <input type="hidden" name="isssn" id="isssn" value="n">
        <p><label>아이디 : <input type="text" name="userid" id="userid" maxlength="20">
        </label>
        	<input type="button" id="btnIdCheck" value="아이디 중복체크">
        </p>
        <p id="idcheckmsg"></p>
        <p><label>비밀번호 : <input type="password" name="userpw" id="userpw" 
            maxlength="20"></label></p>
        <p><label>비밀번호 확인 : <input type="password" name="userpw_re" id="userpw_re" 
            maxlength="20"></label></p>
        ...
        <p>취미 : <label>드라이브<input type="checkbox" name="hobby" value="드라이브"></label>
            ...
            <input type="password" name="ssn2" id="ssn2"> <input type="button" value="주민등록번호 검증"
            id="ssnBtn"></p>
            <p><label>우편번호 : <input type="text" name="zipcode" id="sample6_postcode" readonly></label>
            <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 검색"></p>
